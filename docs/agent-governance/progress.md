...
- [ ] Regenerate all 5 portfolio screenshots after Phase 14 changes land — **deferred: requires running dev server + seeded DB**; run `pnpm dev` + `node scripts/regenerate-doc-screenshots.mjs`
