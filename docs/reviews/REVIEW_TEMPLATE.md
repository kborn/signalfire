...
**Prior review:** [link to previous review file]
...
[Honest list of what is working well and should not be touched.]
...
- [ ] FIX-01 — [title] ([dimension])

### High — engineering or product credibility

- [ ] FIX-02 — [title] ([dimension])

### Medium — polish

- [ ] FIX-03 — [title] ([dimension])
