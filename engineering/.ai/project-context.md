...
-   Phase expansion requires updated Definition of Done.
...
-   `specs/` --- product/data scope and phase acceptance criteria
-   `engineering/.ai` --- canonical governance + execution receipts
-   `engineering/design/` --- technical contracts and architecture
    constraints
-   `engineering/scripts/` --- operator/ingestion utility scripts
-   `engineering/runbooks/` --- operational documentation
-   `archive/` --- non-canonical historical records kept for
    traceability
...
-   `engineering/.ai/` --- governance + progress tracking
